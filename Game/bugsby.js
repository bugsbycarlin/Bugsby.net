...
BugsbySprite[0].src = 'Images/Stand.png';
BugsbySprite[1] = new Image();
BugsbySprite[1].src = 'Images/RunLeft1.png';
BugsbySprite[2] = new Image();
BugsbySprite[2].src = 'Images/RunLeft2.png';
BugsbySprite[3] = new Image();
BugsbySprite[3].src = 'Images/RunRight1.png';
BugsbySprite[4] = new Image();
BugsbySprite[4].src = 'Images/RunRight2.png';
BugsbySprite[5] = new Image();
BugsbySprite[5].src = 'Images/Jumping.png';
BugsbySprite[6] = new Image();
BugsbySprite[6].src = 'Images/Falling.png';
BugsbySprite[7] = new Image();
BugsbySprite[7].src = 'Images/Floating.png';
BugsbySprite[8] = new Image();
BugsbySprite[8].src = 'Images/StandFlip.png';
BugsbySprite[9] = new Image();
BugsbySprite[9].src = 'Images/RunLeft1Flip.png';
BugsbySprite[10] = new Image();
BugsbySprite[10].src = 'Images/RunLeft2Flip.png';
BugsbySprite[11] = new Image();
BugsbySprite[11].src = 'Images/RunRight1Flip.png';
BugsbySprite[12] = new Image();
BugsbySprite[12].src = 'Images/RunRight2Flip.png';
BugsbySprite[13] = new Image();
BugsbySprite[13].src = 'Images/JumpingFlip.png';
BugsbySprite[14] = new Image();
BugsbySprite[14].src = 'Images/FallingFlip.png';
BugsbySprite[15] = new Image();
BugsbySprite[15].src = 'Images/FloatingFlip.png';
BugsbySprite[16] = new Image();
BugsbySprite[16].src = 'Images/Dying.png';

BugsbyTracksuitSprite = new Array(17);
BugsbyTracksuitSprite[0] = new Image();
BugsbyTracksuitSprite[0].src = 'Images/StandTracksuit.png';
BugsbyTracksuitSprite[1] = new Image();
BugsbyTracksuitSprite[1].src = 'Images/RunLeft1Tracksuit.png';
BugsbyTracksuitSprite[2] = new Image();
BugsbyTracksuitSprite[2].src = 'Images/RunLeft2Tracksuit.png';
BugsbyTracksuitSprite[3] = new Image();
BugsbyTracksuitSprite[3].src = 'Images/RunRight1Tracksuit.png';
BugsbyTracksuitSprite[4] = new Image();
BugsbyTracksuitSprite[4].src = 'Images/RunRight2Tracksuit.png';
BugsbyTracksuitSprite[5] = new Image();
BugsbyTracksuitSprite[5].src = 'Images/JumpingTracksuit.png';
BugsbyTracksuitSprite[6] = new Image();
BugsbyTracksuitSprite[6].src = 'Images/FallingTracksuit.png';
BugsbyTracksuitSprite[7] = new Image();
BugsbyTracksuitSprite[7].src = 'Images/Floating.png';
BugsbyTracksuitSprite[8] = new Image();
BugsbyTracksuitSprite[8].src = 'Images/StandTracksuitFlip.png';
BugsbyTracksuitSprite[9] = new Image();
BugsbyTracksuitSprite[9].src = 'Images/RunLeft1TracksuitFlip.png';
BugsbyTracksuitSprite[10] = new Image();
BugsbyTracksuitSprite[10].src = 'Images/RunLeft2TracksuitFlip.png';
BugsbyTracksuitSprite[11] = new Image();
BugsbyTracksuitSprite[11].src = 'Images/RunRight1TracksuitFlip.png';
BugsbyTracksuitSprite[12] = new Image();
BugsbyTracksuitSprite[12].src = 'Images/RunRight2TracksuitFlip.png';
BugsbyTracksuitSprite[13] = new Image();
BugsbyTracksuitSprite[13].src = 'Images/JumpingTracksuitFlip.png';
BugsbyTracksuitSprite[14] = new Image();
BugsbyTracksuitSprite[14].src = 'Images/FallingTracksuitFlip.png';
BugsbyTracksuitSprite[15] = new Image();
BugsbyTracksuitSprite[15].src = 'Images/FloatingFlip.png';
BugsbyTracksuitSprite[16] = new Image();
BugsbyTracksuitSprite[16].src = 'Images/Cartwheeling.png';
